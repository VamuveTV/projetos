...
?>
  ...
  <label>Pedido:</label> <input type="text" name="pedido"><br>
...
$conteudo .= '<p>'.$informacoes.'</p>
    ...
    if(mail('fernando@zarbsolution.com.br',"E-ticket Ingresso Solidário [Cópia manual]",$conteudo,$headers)){
      echo "<h3>Tickets enviados com sucesso";
      
      mail($email,"E-ticket Ingresso Solidário",$conteudo,$headers);
      mail('pedrodemenezes.tec@gmail.com',"E-ticket Ingresso Solidário [Cópia manual]",$conteudo,$headers);
