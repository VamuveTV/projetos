		...
		<div class="woocommerce-tabs">
			<ul class="tabs">
				<?php if ( 'yes' == $this->credit_card ) : ?>
					<li class="active"><a href="#tab-credit-card" style="height:30px"><?php _e( 'Credit Card', 'woocommerce-moip' ); ?></a></li>
				<?php endif; ?>

				<?php if ( 'yes' == $this->banking_debit ) : ?>
					<li><a href="#tab-banking-debit" style="height:30px"><?php _e( 'Banking Debit', 'woocommerce-moip' ); ?></a></li>
				<?php endif; ?>

				<?php if ( 'yes' == $this->billet_banking ) : ?>
					<li><a href="#tab-billet" style="height:30px"><?php _e( 'Billet Banking', 'woocommerce-moip' ); ?></a></li>
				<?php endif; ?>
			</ul>

			<?php if ( 'yes' == $this->credit_card ) : ?>
				<div id="tab-credit-card" class="panel entry-content" data-payment-method="CartaoCredito" style="position: relative;top:-90px;display:block">
					<ul>
						<li>
							<label>
