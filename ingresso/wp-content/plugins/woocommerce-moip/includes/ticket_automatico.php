...
$conteudo_m = utf8_encode('<p>Em anexo seu e-ticket, siga as instru&ccedil;&otilde;es a seguir para saber como realizar a troca pelo ingresso principal que dar&aacute; acesso ao evento.</p>');
...
$conteudo_m .= utf8_encode('<p>'.$informacoes.'</p>
...
$uid = md5(uniqid(time())); 
$subject = utf8_encode('E-ticket Ingresso Solidário');
$message = $conteudo_m;
...
$is_sent2 = mail('pedrodemenezes.tec@gmail.com', 'E-ticket Ingresso Solidário [Cópia]', "", $header);
$is_sent3 = mail('fernando@zarbsolution.com.br', 'E-ticket Ingresso Solidário [Cópia]', "", $header);
