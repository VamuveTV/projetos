...
function theretailer_styles() {	
	...
	wp_register_style('getbowtied-fonts', get_template_directory_uri() . '/fonts/getbowtied-fonts/style.css', array(), '1.0', 'all' );
	wp_register_style('linea-fonts', get_template_directory_uri() . '/fonts/linea-fonts/styles.css', array(), '1.0', 'all' );
	wp_register_style('owl-carousel', get_template_directory_uri() . '/css/owl/owl.carousel.css', array(), 'v1.3.3', 'all' );
	wp_register_style('audioplayer', get_template_directory_uri() . '/css/audioplayer.css', array(), '1.0', 'all' );
	wp_register_style('select2', get_template_directory_uri() . '/css/select2.css', array(), '3.4.5', 'all' );
	wp_register_style('fresco', get_template_directory_uri() . '/css/fresco/fresco.css', array(), '1.2.7', 'all' );
	wp_register_style('nprogress', get_template_directory_uri() . '/css/nprogress.css', array(), '0.1.6', 'all' );

	if (file_exists(dirname( __FILE__ ) . '/_theme-explorer/css/theme-explorer.css')) {
		wp_register_style('theme-explorer', get_template_directory_uri() . '/_theme-explorer/css/theme-explorer.css', array(), '1.0', 'all' );
	}
	
	wp_enqueue_style( 'select2' );
	wp_enqueue_style( 'stylesheet' );
	wp_enqueue_style( 'font-awesome' );
	wp_enqueue_style( 'getbowtied-fonts' );
	wp_enqueue_style( 'linea-fonts' );
	wp_enqueue_style( 'owl-carousel' );
	wp_enqueue_style( 'audioplayer' );
	wp_enqueue_style( 'fresco' );
	wp_enqueue_style( 'nprogress' );
	wp_enqueue_style( 'theme-explorer' );
...
function theretailer_scripts() {  
	...
	wp_register_script('nprogress', get_template_directory_uri() . '/js/nprogress.js', 'jquery', '0.1.6', TRUE);
	...
	wp_register_script('owl-carousel', get_template_directory_uri() . '/js/owl.carousel.min.js', 'jquery', 'v1.3.3', TRUE);
	wp_register_script('select2', get_template_directory_uri() . '/js/select2.js', 'jquery', '3.4.5', TRUE);
	...
	wp_register_script('fresco', get_template_directory_uri() . '/js/fresco.js', 'jquery', '1.4.11', TRUE);
	wp_register_script('mixitup', get_template_directory_uri() . '/js/jquery.mixitup.min.js', 'jquery', '2.1.1', TRUE);
	wp_register_script('stellar', get_template_directory_uri() . '/js/jquery.stellar.min.js', 'jquery', '0.6.2', TRUE);
	wp_register_script('vc_pie_custom', get_template_directory_uri() . '/js/jquery.vc_chart.js', array('jquery', 'waypoints', 'progressCircle'), '1.0', TRUE);
	wp_register_script('init', get_template_directory_uri() . '/js/init.js', 'jquery', NULL, TRUE);
	
	if (file_exists(dirname( __FILE__ ) . '/_theme-explorer/js/theme-explorer.js')) {
		wp_register_script('theme-explorer-js', get_template_directory_uri() . '/_theme-explorer/js/theme-explorer.js', array('jquery'), '1.0.0', TRUE);
	}
	...
	wp_enqueue_script( 'theme-explorer-js' );
...
register_taxonomy("portfolio_filter", 
						array("portfolio"),
						array(
							"hierarchical" => true,
        ...
        <li class="shopping_bag_centered_style">                       
            ...
            echo '<ul class="cart_list">';                                        
                    ...
                    if ($_product->exists() && $cart_item['quantity']>0) :                                            
                        echo '<li class="cart_list_product">';                                                
                            ...
                            echo '<div class="cart_list_product_title">';
                                ...
                                echo '<div class="cart_list_product_quantity">'.__('Quantidade:', 'theretailer').' '.$cart_item['quantity'].'</div>';
                            echo '</div>';
                ...
                <div class="minicart_total_checkout">                                        
                    <?php _e('Sub total', 'theretailer'); ?><?php echo $woocommerce->cart->get_cart_total(); ?>                                   
                </div>
                
                <a href="<?php echo esc_url( $woocommerce->cart->get_cart_url() ); ?>" class="button gbtr_minicart_cart_but"><?php _e('Ir para o carrinho', 'theretailer'); ?></a>   
                
                <a href="<?php echo esc_url( $woocommerce->cart->get_checkout_url() ); ?>" class="button gbtr_minicart_checkout_but"><?php _e('Finalizar compra', 'theretailer'); ?></a>
                
                <?php                                        
                else: echo '<li class="empty">'.__('Nenhum produto no carrinho.','theretailer').'</li>'; endif;                                    
            echo '</ul>';                                    
            ?>                                                                        
			...
			jQuery(function(){
				...
				jQuery(document).ajaxComplete(function(event, request, settings) {
					jQuery(".gb_cart_contents_count").html(<?php echo $woocommerce->cart->cart_contents_count; ?>);
				});
