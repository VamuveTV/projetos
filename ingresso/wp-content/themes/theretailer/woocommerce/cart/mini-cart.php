...
<ul class="cart_list product_list_widget <?php echo $args['list_class']; ?>">
	...
	<?php else : ?>
		...
		<li class="empty"><?php _e( 'Nenhum produto no carrinho.', 'theretailer' ); ?></li>
...
<?php if ( sizeof( $woocommerce->cart->get_cart() ) > 0 ) : ?>
	...
	<p class="total"><strong><?php _e( 'subtotal', 'theretailer' ); ?>:</strong> <?php echo $woocommerce->cart->get_cart_subtotal(); ?></p>
