...
<em class="items_found_cart"><?php echo sprintf(_n('%d item', '%d items', $woocommerce->cart->cart_contents_count, 'theretailer'), $woocommerce->cart->cart_contents_count);?> <?php _e('encontrado(s)', 'theretailer'); ?></em>
...
<div class="gbtr_main_wrapper">
            ...
            <table class="shop_table footable" cellspacing="0">
                <thead>
                    <tr>
                        ...
                        <th data-hide="phone" class="product-quantity"><?php _e('Quantidade', 'theretailer'); ?></th>
    ...
    <div class="grid_4 omega">
        ...
        <div class="gbtr_left_column_cart">            
            ...
            <input type="submit" class="update-button button" name="update_cart" value="<?php _e('Atualizar carrinho', 'theretailer'); ?>" />
                        
            <input type="submit" class="checkout-button button" name="proceed" value="<?php _e('Finalizar compra', 'theretailer'); ?>" />
