...
/**
 * This is the model class for table "tbl_pontos".
 *
 * The followings are the available columns in table 'tbl_pontos':
 * @property integer $id
 * @property string $uf
