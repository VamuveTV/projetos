...
<table class="table table-striped table-bordered bootstrap-datatable datatable">
  <thead>
      ...
      <tr>
          ...
          <th><input type="text" id="buscaDescricao" class="campo_busca" value="<?php echo $_POST['descricao'];?>"></th>
          <th></th>
          <th></th>
      </tr>
  </thead>   
  ...
  <?php
      ...
      $sql = "SELECT * FROM produtos_config WHERE codigo > 0 ";
      if($_POST['cod'])
          $sql.= "AND codigo='".$_POST['cod']."' ";
      if($_POST['nome'])
          $sql.= "AND nome LIKE '%".$_POST['nome']."%' ";
      if($_POST['descricao'])
          $sql.= "AND descricao LIKE '%".$_POST['descricao']."%' ";
...
$sql = "SELECT * FROM produtos_config";
$res = mysql_query($sql);
