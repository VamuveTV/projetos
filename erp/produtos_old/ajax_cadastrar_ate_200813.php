<?php
	...
	$campos =  array("nome","unidade","descricao","skumagento","cor","tamanho","frete","lancamento","peso","marca");
	$sku = rand(0,1000).date("Ymds"); //sku para o magento
	$dados = array($_POST["nome"],$_POST["unidade"],$_POST["descricao"],$sku,$_POST["cor"],$_POST["tamanho"],$_POST["frete"],$_POST["lancamento"],$_POST["peso"],$_POST["marca"]);
	$tabela = "produtos";
