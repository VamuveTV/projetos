...
<table class="table table-striped table-bordered bootstrap-datatable datatable">
  <thead>
	  <tr>
		<th colspan='5'>
          ...
          <tr>
              ...
              <th><input type="text" id="buscaCodbarras" class="campo_busca" value="<?php echo $_POST['codbarras'];?>"></th>
              <th></th>
              <th></th>
              <th></th>
              <th></th>
    ...
    <tbody>
        ...
        $sql2 = "SELECT p.codigo AS parcela, v.codigo AS venda, p.data, p.codbarras, c.nome AS cliente, p.valor, p.recebido, p.recebimento
				FROM vendas AS v INNER JOIN clientes AS c ON c.codigo=v.cliente 
				INNER JOIN parcelas AS p ON v.codigo=p.venda WHERE c.nome LIKE '%".$_POST['nome']."%' AND p.codbarras LIKE '%".$_POST['codbarras']."%' AND p.codigo LIKE '%".$_POST['cod']."%'";
		$sql2.= "ORDER BY c.nome, p.data desc";
  ...
  ?>
		<tr >
			<td class="center"><?php echo $dados2['parcela']; ?></td>
            <td class="center"><?php echo $dados2['cliente']; ?></td>
            <td class="center"><?php echo $dados2['codbarras']; ?></td>
			<td ><a class="btn"  href="../vendas/index.php?cod=<?php echo $dados2['venda']; ?>&tela_edita=1" target="_blank" ><?php echo $dados2['venda']; ?></a></td>
