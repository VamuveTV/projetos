...
<fieldset>
	...
	<div class="control-group">
	  ...
	  <div class="controls">
	    <input id="input-email" name="input-email" placeholder="" class="input-xlarge" type="email">
	...
	<div class="control-group">
	  ...
	  <div class="controls">
	    <input id="input-data" name="input-data" placeholder="" class="input-xlarge" required="" type="text">
	  </div>
    </div>
