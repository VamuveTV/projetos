...
<fieldset>
  ...
  <tbody>
    <?php
      $sql = "SELECT p.codigo, p.nome, p.foto AS foto_produto, gp.foto
  ...
  <tr>
      ...
      <td><img src="../erp/produtos/fotos/<?php if($dados['foto_produto'] == "") echo $dados['foto']; else echo $dados['foto_produto']; ?>" </td>
      <td align="center">
