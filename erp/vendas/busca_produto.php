...
$sql = "SELECT p.codigo, p.nome, p.foto, p.referencia, gp.descricao FROM produtos AS p, grupo_produtos AS gp WHERE p.grupo=gp.codigo AND ($q2) order by p.nome LIMIT $inicio, $limite";
